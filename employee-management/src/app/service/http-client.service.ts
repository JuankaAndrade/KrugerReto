...
export class HttpClientService {
  ...
  constructor(
    ...
    public activeEmployee(employee:any) {
      let username='user'
      let password='password'
    
      const headers = new HttpHeaders({ Authorization: 'Basic ' + btoa(username + ':' + password) });
      return this.httpClient.delete<Employee>("http://localhost:8080/employees" + "/activar/"+ employee.empId,{headers});
    }
